...
namespace TestApp
{
	...
	class TestApp
	{
		...
		static void Main(string[] args)
		{
			...
			catch(Exception ex) /// a exceção lida caso não consiga rodar o app
			{
		...
		private static void RunTestApp()   ///roda o app
		{
			...
			if (Controller.DriverVersion != 0x0100) /// invalida se a versão for diferente
			{
				Console.WriteLine("ERROR: Invalid uuirtdrv version!\n");
				return;
			}

    			using (Controller mc = new Controller())  ///atribui o controle a variável mc
			{
